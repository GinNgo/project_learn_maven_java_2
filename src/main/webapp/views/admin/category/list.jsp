...
name="id" value="${category.id }" id="id" class="form-control" readonly/>
...
type="text" class="form-control" name="code" value="${category.code }"
...
<input id="statuson" class="form-check-input" type="radio" name="status" ${category.status ==1 ? 'checked':''} value="1">

<label for="statuson" class="form-check-label">Hoạt động</label><br>

<input id="statusoff" class="form-check-input" type="radio" name="status" ${category.status == 0 ? 'checked':''} value="0">
...
<c:url value="/image?fname=category/${item.images!=null?item.images:'uploads/abc.jpg'}" var="imgUrl"></c:url>
